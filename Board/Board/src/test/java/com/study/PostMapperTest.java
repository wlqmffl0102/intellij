...
import com.study.post.PostMapper;
import com.study.post.PostRequest;
import com.study.post.PostRespone;
...
public class PostMapperTest {
   ...
   /* @Test
    void save() {
        ...
        List<PostRespone> posts = postMapper.findAll();
        System.out.println("전체 게시글 개수는 : " + posts.size() + "개입니다.");
    }

    @Test
    void findById() {
        PostRespone post = postMapper.findById(1L);
        try {
